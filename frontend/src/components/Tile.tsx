...
//                 {!highlight && image && <div className="chess-piece w-[100px] h-[100px] bg-no-repeat bg-center hover:cursor-grab active:cursor-grabbing" style={{ backgroundImage: `url(${image})` }}>
//                 </div>}
//                 {highlight && !image && <div className="absolute w-[24px] h-[24px] bg-[rgba(0,0,0,0.4)] rounded-full"></div>}
//                 {highlight && image &&
//                     <div>
//                         <div className="absolute w-[100px] h-[100px] border-5 border-[rgba(0,0,0,0.4)] border-solid rounded-full"></div>
//                         <div className="chess-piece w-[100px] h-[100px] bg-no-repeat bg-center hover:cursor-grab active:cursor-grabbing" style={{ backgroundImage: `url(${image})` }}></div>
//                     </div>}
//             </div >
//         ) :
